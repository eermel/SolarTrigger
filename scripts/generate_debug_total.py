...
data = {
    "_comment":        "Generated by generate_debug_total.py — quick local test",
...
print(f"  C2      : {fmt(C2)} UTC  (totality start, +5min)")
print(f"  TMAX    : {fmt(TMAX)} UTC  (midpoint, {int(totality_sec)}s of totality)")
print(f"  C3      : {fmt(C3)} UTC  (totality end)")
